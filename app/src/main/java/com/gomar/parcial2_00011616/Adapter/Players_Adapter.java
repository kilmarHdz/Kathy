...
public class Players_Adapter extends RecyclerView.Adapter<Players_Adapter.PlayersViewHolder>{
    View view;
    private final LayoutInflater layoutInflater;
    private List<PlayersEntity> playerList;
    ...
    public void fillPlayers(List<PlayersEntity> playerList){
